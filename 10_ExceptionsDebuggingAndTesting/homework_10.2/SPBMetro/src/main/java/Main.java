...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        searchLogger = LogManager.getLogger("search.spb.metro");
        inputErrorsLogger = LogManager.getLogger("input.spb.metro");
        exceptionsLogger = LogManager.getLogger("exceptions.spb.metro");
